	...
	<div class="flex flex-col h-full w-full" v-if="isFormReady">
		<div class="w-full h-full bg-white sm:w-96 flex flex-col">
			...
			<div class="bg-white grow">
				...
				<div id="app" class="items-center justify-center p-5">
					...
					<div v-if="isCameraOpen" v-show="!isLoading" class="camera-box" :class="{ 'flash' : isShotPhoto }">
					  ...
					  <canvas v-show="isPhotoTaken" id="photoTaken" ref="canvas" :width="400" :height="337.5"></canvas>
					</div>
					</div>
					<div style="display:flex">
					<div class="camera-shoot">
					  <button type="button" class="button" @click="takePhoto" v-if="isCameraOpen">
...
name: 'App',
  ...
  methods: {
    ...
    takePhoto() {
      ...
      context.drawImage(this.$refs.camera, 15, 15, 300, 200);
    },
